...
from controle.fonctions import creation_tournois, creation_liste_joueur, add_players_to_tournament, creation_paires, matchs,\
...
from modeles.modele import creation_joueurs, liste_acteurs_odre_alphabetique, liste_joueurs, liste_des_tournois,\
...
def main():
    ...
    while True:
        ...
        while cmd == "2":
            ...
            if numero_tour == 5:
                print("Tour 5")
                LISTE_COMMANDES_POUR_LES_TOURNOIS[1] = "Le tournois est fini, vous pouvez modifier les classements " \
                                                       "ici(2)"
            else:
